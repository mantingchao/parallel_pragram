	...
	.p2align	4                               ## -- Begin function _Z5test3Pdi
LCPI0_0:
...
LCPI0_1:
	...
	.p2align	3
LCPI0_2:
	.quad	0x3db5fd7fe1796496              ## double 2.0000000000000002E-11
	.section	__TEXT,__text,regular,pure_instructions
	.globl	__Z5test3Pdi
	.p2align	4, 0x90
__Z5test3Pdi:                           ## @_Z5test3Pdi
	.cfi_startproc
## %bb.0:
	pushq	%rbp
	...
	movq	%rdi, %rbx
	xorl	%r13d, %r13d
	leaq	__ZZL5tdiffyyE8timebase(%rip), %r14
	.p2align	4, 0x90
...
## %bb.7:
	...
	movl	__ZZL5tdiffyyE8timebase(%rip), %ecx
	subq	%r15, %r12
	movq	%r12, %xmm0
...
## %bb.0:
	...
	callq	__ZSt9terminatev
                                        ## -- End function
	.p2align	4, 0x90                         ## -- Begin function _Z5test3Pdi.cold.1
__Z5test3Pdi.cold.1:                    ## @_Z5test3Pdi.cold.1
	.cfi_startproc
## %bb.0:
	pushq	%rbp
	.cfi_def_cfa_offset 16
