...
// vset: if mask == 1, set value to vecResult.value
template <typename T>
...
//initial vecResult of _pp_vset_float
...
//initial vecResult of _pp_vset_int
...
// vmove: if mask == 1, move src.value to dest.value
template <typename T>
...
// vload: if mask == 1, load src to dest.value
template <typename T>
...
// vstore: if mask == 1, store src.value to dest
template <typename T>
...
// vadd: if mask == 1, add veca.value + vecb.value
template <typename T>
...
// vsub: if mask == 1, add veca.value - vecb.value
template <typename T>
...
// vmult: if mask == 1, add veca.value * vecb.value
template <typename T>
...
// vdiv: if mask == 1, add veca.value / vecb.value
template <typename T>
...
// vabs: if mask == 1, add abs veca.value
template <typename T>
...
// vgt: if mask == 1, compare whether veca.value > vecb.value
template <typename T>
...
// vlt: if mask == 1, compare whether veca.value < vecb.value
template <typename T>
...
// veq: if mask == 1, compare whether veca.value == vecb.value
template <typename T>
